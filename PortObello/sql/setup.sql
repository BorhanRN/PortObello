...
(
    ...
    FOREIGN KEY (PortAddress) REFERENCES Port (Address) ON DELETE CASCADE
);
...
(
    ...
    FOREIGN KEY (TerminalPortAddress) REFERENCES Port (Address) ON DELETE CASCADE
);
...
(
    ...
    DockedAtPortAddress VARCHAR2(200),
    PRIMARY KEY (Owner, ShipName),
    FOREIGN KEY (ShippingRouteName) REFERENCES ShippingRoute (Name) ON DELETE CASCADE,
    FOREIGN KEY (DockedAtPortAddress) REFERENCES Port (Address) ON DELETE CASCADE
);
...
(
    ...
    FOREIGN KEY (ShipOwner, ShipName) REFERENCES Ship (Owner, ShipName) ON DELETE CASCADE,
    FOREIGN KEY (TradeAgreement) REFERENCES Tariff (TradeAgreement) ON DELETE CASCADE
);
...
-- Insert Statements
INSERT INTO Country (Name, Population, Government, PortAddress)
VALUES ('Canada', 38930000, 'Liberal Party - Justin Trudeau', '999 Canada Pl, Vancouver, BC V6C 3T4');

INSERT INTO Port (Address, NumWorkers, DockedShips, CountryName)
VALUES ('999 Canada Pl, Vancouver, BC V6C 3T4', 523, 53, 'Canada');

INSERT INTO Warehouse (PortAddress, Section, NumContainers, Capacity)
VALUES ('999 Canada Pl, Vancouver, BC V6C 3T4', 1, 90, 100);

INSERT INTO HomeCountry (Name, Population, GDP, Government, DockingFee)
VALUES ('Canada', 38930000, 1643.5, 'Liberal Party - Justin Trudeau', 500.0);

INSERT INTO ForeignCountry (Name, Population, GDP, Government, DockingFee)
VALUES ('USA', 331000000, 21137.0, 'Democratic Party - Joe Biden', 600.0);

INSERT INTO Tariff (TradeAgreement, TariffRate, HomeName, ForeignName, EnactmentDate)
VALUES ('Canada-USA Agreement', 5.0, 'Canada', 'USA', TO_DATE('2020-01-30', 'YYYY-MM-DD'));

INSERT INTO ShippingRoute (Name, Length, OriginCountryName, TerminalPortAddress)
VALUES ('Great Circle', 4078, 'USA', '999 Canada Pl, Vancouver, BC V6C 3T4');

INSERT INTO Ship (Owner, ShipName, ShippingRouteName, DockedAtPortAddress)
VALUES ('Maersk', 'Ocean Breeze', 'Great Circle', '999 Canada Pl, Vancouver, BC V6C 3T4');

INSERT INTO ShipmentContainer (ShipOwner, ShipName, GoodType, ContainerSize, Weight, TrackingNumber, TradeAgreement,
                               CompanyName, CompanyCEO)
VALUES ('Maersk', 'Ocean Breeze', 'Electronics', 45.0, 300.0, 1001, 'Canada-USA Agreement', 'TechCo', 'Alice Johnson');
